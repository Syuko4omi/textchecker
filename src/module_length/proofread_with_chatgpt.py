...
def proofreader(sentence, style):
    ...
    except Exception as error:  # その他のエラー
    ...
    proofread_chain = create_chain(templates.proofread_template)  # 校正用のチェーン
    style_trans_chain = create_chain(style_trans_template)  # 文体変換用のチェーン
