...
curl -OL http://public.shiroyagi.s3.amazonaws.com/latest-ja-word2vec-gensim-model.zip && unzip latest-ja-word2vec-gensim-model.zip && rm latest-ja-word2vec-gensim-model.zip && rm *.npy
